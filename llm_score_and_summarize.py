...
- Sounds like a real human wrote it—natural, conversational, authentic
- Avoids typical AI language patterns, clichés, and formulaic phrases
...
def call_llm(prompt):
    ...
    payload = {
        "messages": [
            {"role": "system", "content": "You are a senior cybersecurity analyst who writes in a natural, human voice. You avoid AI clichés and formulaic language. Your writing sounds authentic and conversational, like a real person sharing genuine insights, not an AI summarizing information."},
        ...
        if headline:
            ...
            if linkedin_match:
                ...
                <div class="linkedin-ready">
                    <h3>📱 LinkedIn Post (Ready to Copy/Paste)</h3>
